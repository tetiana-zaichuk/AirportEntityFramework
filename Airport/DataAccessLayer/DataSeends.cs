...
namespace DataAccessLayer
{
    public static class DataSeends
    {
        ...
        {
            new Crew(){ DepartureId = 1, Pilot = new Pilot(){ FirstName = "Adam", LastName = "Black", Dob = new DateTime(1978,03,03), Experience = 9}, Stewardesses = {}},
            new Crew(){ DepartureId = 2, Pilot = new Pilot(){ FirstName = "John", LastName = "Smith", Dob = new DateTime(1983,07,11), Experience = 5}, Stewardesses = {}},
            new Crew(){ DepartureId = 3, Pilot = new Pilot(){ FirstName = "Jane", LastName = "Smith", Dob = new DateTime(1980,07,11), Experience = 7}, Stewardesses = {}}
        };
